...
const FeaturedImageFragment = require("/src/fragments/featuredImageFragment")

//POSTS BY CATEGORY PAGES
...
//POSTS PAGES (with featured images)
exports.createPages = async ({ graphql, actions, reporter }) => {
  const { createPage } = actions
  const archiveTemplate = path.resolve("./src/templates/post.js")
}
